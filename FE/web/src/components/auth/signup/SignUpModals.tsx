  ...
  if (modal === 'parent-confirm') {
    return (
      <AuthModal
        actions={
          <>
            <button className="auth-button is-neutral" onClick={onClose} type="button">
              이전
            </button>
            <button
      ...
      >
        ...
        <div className="auth-modal-fields">
          <AuthInput label="부모 이름" readOnly value="홍길동" />
          <AuthInput label="부모 이메일" readOnly value={parentEmail} />
        </div>
      </AuthModal>
    )
  }
