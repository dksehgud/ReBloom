...
import ChildLogoutConfirmModal from '../../user/components/ChildLogoutConfirmModal'
import ChildPasswordChangeModal from '../../user/components/ChildPasswordChangeModal'
import ParentBottomNavigation from './ParentBottomNavigation'
import ParentCounselorConnectModal from './ParentCounselorConnectModal'
          ...
          <div className="parent-settings-page__box">
            {!hasConnectedChild ? (
              ...
              <ParentSettingsRow
                title={
                  <>
                    <span>{connectedCounselor.name}</span>
                    {connectedCounselor.clinicName ? (
                      <span className="parent-settings-page__inline-meta">
                        {connectedCounselor.clinicName}
                      </span>
                    ) : null}
                ...
                description={
                  connectedCounselor.email ? (
                    <a
                      className="parent-settings-page__linked-email"
                      href={`mailto:${connectedCounselor.email}`}
                    >
                      {connectedCounselor.email}
                    </a>
                  ) : null
