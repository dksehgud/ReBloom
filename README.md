...
| 회원가입 | 기기 연동 | 아이 일기 작성 |
| --- | --- | --- |
| <img src="docs/산출물/회원가입.gif" width="260" alt="회원가입"> | <img src="docs/산출물/기기연동.gif" width="260" alt="기기 연동"> | <img src="docs/산출물/아이%20일기작성.gif" width="260" alt="아이 일기 작성"> |

| 부모 관찰 기록 작성 | 부모 관찰 기록 확인 | 부모 알림 확인 |
| --- | --- | --- |
| <img src="docs/산출물/부모%20관찰일기작성.gif" width="260" alt="부모 관찰 기록 작성"> | <img src="docs/산출물/부모관찰기록확인.gif" width="260" alt="부모 관찰 기록 확인"> | <img src="docs/산출물/부모알림확인.gif" width="260" alt="부모 알림 확인"> |
