package com.ssafy.rebloom.common.exception;
...
public enum ErrorCode {
    ...
    TARGET_LOCATION_NOT_CONFIGURED(HttpStatus.CONFLICT, "Target location is not configured."),

    // ============================================================
    // 2. PARENT(부모)
    // ============================================================
    INVALID_PARENT_CODE(HttpStatus.NOT_FOUND, "유효하지 않은 부모 코드입니다."),
