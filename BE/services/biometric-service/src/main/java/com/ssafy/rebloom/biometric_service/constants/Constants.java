package com.ssafy.rebloom.biometric_service.constants;

public final class Constants {
    public static final long TRAINING_COUNT = 288L;
    public static final String MODEL_TYPE_ISOLATION_FOREST = "ISOLATION_FOREST";
